...
reader = MyDatasetReader(token_indexers={"tokens": PretrainedBertIndexer(BERT_BASE_UNCASED, max_pieces=256)})
...
dump_metrics(os.path.join(config.get('Train', 'trecqa_serialization_dir'), "metrics.json"), metrics, log=True)